...
export interface SelectProps extends React.ComponentProps<typeof SelectPrimitive.Root>, VariantProps<typeof selectVariants> {}
...
const SelectTrigger = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger> & SelectProps // Extend with VariantProps
>(({ className, size, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(selectVariants({ size, className }))} // Apply selectVariants with size and variant
    {...props}
  >
    {children}
